...
const page = () => {
  ...
  const producstname = [
    { name: 'shaker', price: '$1600', oldPrice: '$2500', color: 'Red', color1: 'Blue', color2: 'Green', size: '40', size1: '42', size2: '38' },
    { name: 'shaker', price: '$1600', oldPrice: '$2500', color: 'Red', color1: 'Blue', color2: 'Green', size: '42', size1: '44', size2: '46' },
    { name: 'shaker', price: '$1600', oldPrice: '$2500', color: 'Red', color1: 'Blue', color2: 'Green', size: '38', size1: '44', size2: '46' },
    { name: 'shaker', price: '$1600', oldPrice: '$2500', color: 'Red', color1: 'Blue', color2: 'Green', size: 'M', size1: '44', size2: '46' },
    { name: 'shaker', price: '$1600', oldPrice: '$2500', color: 'Red', color1: 'Blue', color2: 'Green', size: '40', size1: '44', size2: '46' },
    { name: 'shaker', price: '$1600', oldPrice: '$2500', color: 'Red', color1: 'Blue', color2: 'Green', size: '41', size1: '44', size2: '46' },
    { name: 'shaker', price: '$1600', oldPrice: '$2500', color: 'Red', color1: 'Blue', color2: 'Green', size: '38', size1: '44', size2: '46' },
    { name: 'shaker', price: '$1600', oldPrice: '$2500', color: 'Red', color1: 'Blue', color2: 'Green', size: 'M', size1: '44', size2: '46' },
    { name: 'shaker', price: '$1600', oldPrice: '$2500', color: 'Red', color1: 'Blue', color2: 'Green', size: '40', size1: '42', size2: '38' },
    { name: 'shaker', price: '$1600', oldPrice: '$2500', color: 'Red', color1: 'Blue', color2: 'Green', size: '42', size1: '44', size2: '46' },
    ...
    <div className="container mx-auto px-4 py-4">
      ...
      <div className=' flex items-center justify-start gap-2' >
       <Link href={'/'} > <p className=' text-sm cursor-pointer ' >Home</p> </Link>
        ...
        <p className=' text-sm cursor-pointer text-green-700 ' >Belt</p>
      </div>
      ...
      <div className=" pt-8 ">
         <div className="flex items-center ">
          ...
          <h2 className=" text-lg lg:text-2xl font-bold mb-4 ml-2 ">Belt</h2>
        </div>
